...
from pogoprotos.data.combat import player_combat_stats_pb2 as pogoprotos_dot_data_dot_combat_dot_player__combat__stats__pb2
...
_PLAYERSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='km_walked_past_active_day', full_name='pogoprotos.data.player.PlayerStats.km_walked_past_active_day', index=32,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_challenge_quests_completed', full_name='pogoprotos.data.player.PlayerStats.num_challenge_quests_completed', index=33,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_trades', full_name='pogoprotos.data.player.PlayerStats.num_trades', index=34,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_max_level_friends', full_name='pogoprotos.data.player.PlayerStats.num_max_level_friends', index=35,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='trade_accumulated_distance_km', full_name='pogoprotos.data.player.PlayerStats.trade_accumulated_distance_km', index=36,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fitness_report_last_check_bucket', full_name='pogoprotos.data.player.PlayerStats.fitness_report_last_check_bucket', index=37,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='combat_stats', full_name='pogoprotos.data.player.PlayerStats.combat_stats', index=38,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_npc_combats_won', full_name='pogoprotos.data.player.PlayerStats.num_npc_combats_won', index=39,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_npc_combats_total', full_name='pogoprotos.data.player.PlayerStats.num_npc_combats_total', index=40,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_photobomb_seen', full_name='pogoprotos.data.player.PlayerStats.num_photobomb_seen', index=41,
...
_PLAYERSTATS.fields_by_name['combat_stats'].message_type = pogoprotos_dot_data_dot_combat_dot_player__combat__stats__pb2._PLAYERCOMBATSTATS
