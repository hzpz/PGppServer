...
_INCOMINGFRIENDINVITE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='invitation_type', full_name='pogoprotos.data.friends.IncomingFriendInvite.invitation_type', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='full_name', full_name='pogoprotos.data.friends.IncomingFriendInvite.full_name', index=4,
...
_INCOMINGFRIENDINVITE.fields_by_name['invitation_type'].enum_type = pogoprotos_dot_enums_dot_invitation__type__pb2._INVITATIONTYPE
