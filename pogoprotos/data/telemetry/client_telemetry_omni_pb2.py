...
from pogoprotos.data.player import user_attributes_pb2 as pogoprotos_dot_data_dot_player_dot_user__attributes__pb2
...
_CLIENTTELEMETRYOMNI = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='server_data', full_name='pogoprotos.data.telemetry.ClientTelemetryOmni.server_data', index=44,
...
_CLIENTTELEMETRYOMNI.fields_by_name['user_attributes'].message_type = pogoprotos_dot_data_dot_player_dot_user__attributes__pb2._USERATTRIBUTES
...
_CLIENTTELEMETRYOMNI.oneofs_by_name['TelemetryData'].fields.append(
  _CLIENTTELEMETRYOMNI.fields_by_name['server_data'])
_CLIENTTELEMETRYOMNI.fields_by_name['server_data'].containing_oneof = _CLIENTTELEMETRYOMNI.oneofs_by_name['TelemetryData']
