...
_POKEMONID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MELTAN', index=494, number=808,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MELMETAL', index=495, number=809,
      serialized_options=None,
      type=None),
  ],
