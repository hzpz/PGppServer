...
# source: pogoprotos/networking/responses/social/update_notification_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/update_notification_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nIpogoprotos/networking/responses/social/update_notification_response.proto\x12&pogoprotos.networking.responses.social\x1a)pogoprotos/enums/notification_state.proto\"\x87\x01\n\x1aUpdateNotificationResponse\x12\x18\n\x10notification_ids\x18\x01 \x03(\t\x12\x1b\n\x13\x63reate_timestamp_ms\x18\x02 \x03(\x03\x12\x32\n\x05state\x18\x03 \x01(\x0e\x32#.pogoprotos.enums.NotificationStateb\x06proto3')
  ,
...
_UPDATENOTIFICATIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.UpdateNotificationResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='notification_ids', full_name='pogoprotos.networking.responses.social.UpdateNotificationResponse.notification_ids', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create_timestamp_ms', full_name='pogoprotos.networking.responses.social.UpdateNotificationResponse.create_timestamp_ms', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='pogoprotos.networking.responses.social.UpdateNotificationResponse.state', index=2,
...
UpdateNotificationResponse = _reflection.GeneratedProtocolMessageType('UpdateNotificationResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.update_notification_response_pb2'
