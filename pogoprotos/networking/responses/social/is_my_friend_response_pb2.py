...
# source: pogoprotos/networking/responses/social/is_my_friend_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/is_my_friend_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nBpogoprotos/networking/responses/social/is_my_friend_response.proto\x12&pogoprotos.networking.responses.social\"\xd3\x01\n\x12IsMyFriendResponse\x12Q\n\x06result\x18\x01 \x01(\x0e\x32\x41.pogoprotos.networking.responses.social.IsMyFriendResponse.Result\x12\x11\n\tis_friend\x18\x02 \x01(\x08\"W\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x12\"\n\x1e\x45RROR_PLAYER_NOT_FOUND_DELETED\x10\x03\x62\x06proto3')
)
...
_ISMYFRIENDRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.IsMyFriendResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ISMYFRIENDRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.IsMyFriendResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.IsMyFriendResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='is_friend', full_name='pogoprotos.networking.responses.social.IsMyFriendResponse.is_friend', index=1,
...
IsMyFriendResponse = _reflection.GeneratedProtocolMessageType('IsMyFriendResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.is_my_friend_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.IsMyFriendResponse)
  ))
