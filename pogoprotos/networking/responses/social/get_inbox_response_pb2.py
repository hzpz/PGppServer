...
# source: pogoprotos/networking/responses/social/get_inbox_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/get_inbox_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n?pogoprotos/networking/responses/social/get_inbox_response.proto\x12&pogoprotos.networking.responses.social\x1a(pogoprotos/data/inbox/client_inbox.proto\"\xc5\x01\n\x10GetInboxResponse\x12O\n\x06result\x18\x01 \x01(\x0e\x32?.pogoprotos.networking.responses.social.GetInboxResponse.Result\x12\x31\n\x05inbox\x18\x02 \x01(\x0b\x32\".pogoprotos.data.inbox.ClientInbox\"-\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x0b\n\x07\x46\x41ILURE\x10\x02\x62\x06proto3')
  ,
...
_GETINBOXRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.GetInboxResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GETINBOXRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.GetInboxResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.GetInboxResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='inbox', full_name='pogoprotos.networking.responses.social.GetInboxResponse.inbox', index=1,
...
GetInboxResponse = _reflection.GeneratedProtocolMessageType('GetInboxResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.get_inbox_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.GetInboxResponse)
  ))
