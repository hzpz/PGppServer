...
# source: pogoprotos/networking/responses/social/send_friend_invite_response.proto
...
_SENDFRIENDINVITERESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.SendFriendInviteResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SENDFRIENDINVITERESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.SendFriendInviteResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.SendFriendInviteResponse.result', index=0,
...
SendFriendInviteResponse = _reflection.GeneratedProtocolMessageType('SendFriendInviteResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.send_friend_invite_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.SendFriendInviteResponse)
  ))
