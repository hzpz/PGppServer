...
# source: pogoprotos/networking/responses/social/update_facebook_status_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/update_facebook_status_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nLpogoprotos/networking/responses/social/update_facebook_status_response.proto\x12&pogoprotos.networking.responses.social\"\xff\x01\n\x1cUpdateFacebookStatusResponse\x12[\n\x06result\x18\x01 \x01(\x0e\x32K.pogoprotos.networking.responses.social.UpdateFacebookStatusResponse.Result\"\x81\x01\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x12\x1a\n\x16\x45RROR_PLAYER_NOT_FOUND\x10\x03\x12\x16\n\x12\x45RROR_FACEBOOK_API\x10\x04\x12\x18\n\x14\x45RROR_ALREADY_EXISTS\x10\x05\x62\x06proto3')
)
...
_UPDATEFACEBOOKSTATUSRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.UpdateFacebookStatusResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_UPDATEFACEBOOKSTATUSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.UpdateFacebookStatusResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.UpdateFacebookStatusResponse.result', index=0,
...
UpdateFacebookStatusResponse = _reflection.GeneratedProtocolMessageType('UpdateFacebookStatusResponse', (_message.Message,), dict(
  DESCRIPTOR = _UPDATEFACEBOOKSTATUSRESPONSE,
  __module__ = 'pogoprotos.networking.responses.social.update_facebook_status_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.UpdateFacebookStatusResponse)
  ))
