...
# source: pogoprotos/networking/responses/social/decline_friend_invite_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/decline_friend_invite_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nKpogoprotos/networking/responses/social/decline_friend_invite_response.proto\x12&pogoprotos.networking.responses.social\"\xf2\x01\n\x1b\x44\x65\x63lineFriendInviteResponse\x12Z\n\x06result\x18\x01 \x01(\x0e\x32J.pogoprotos.networking.responses.social.DeclineFriendInviteResponse.Result\"w\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x12\x1f\n\x1b\x45RROR_INVITE_DOES_NOT_EXIST\x10\x03\x12!\n\x1d\x45RROR_INVITE_ALREADY_DECLINED\x10\x04\x62\x06proto3')
)
...
_DECLINEFRIENDINVITERESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.DeclineFriendInviteResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_DECLINEFRIENDINVITERESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.DeclineFriendInviteResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.DeclineFriendInviteResponse.result', index=0,
...
DeclineFriendInviteResponse = _reflection.GeneratedProtocolMessageType('DeclineFriendInviteResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.decline_friend_invite_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.DeclineFriendInviteResponse)
  ))
