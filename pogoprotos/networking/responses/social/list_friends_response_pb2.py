...
# source: pogoprotos/networking/responses/social/list_friends_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/list_friends_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nBpogoprotos/networking/responses/social/list_friends_response.proto\x12&pogoprotos.networking.responses.social\x1a$pogoprotos/data/friends/friend.proto\"\xcf\x01\n\x13ListFriendsResponse\x12R\n\x06result\x18\x01 \x01(\x0e\x32\x42.pogoprotos.networking.responses.social.ListFriendsResponse.Result\x12/\n\x06\x66riend\x18\x02 \x03(\x0b\x32\x1f.pogoprotos.data.friends.Friend\"3\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x62\x06proto3')
  ,
...
_LISTFRIENDSRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.ListFriendsResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LISTFRIENDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.ListFriendsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.ListFriendsResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='friend', full_name='pogoprotos.networking.responses.social.ListFriendsResponse.friend', index=1,
...
ListFriendsResponse = _reflection.GeneratedProtocolMessageType('ListFriendsResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.list_friends_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.ListFriendsResponse)
  ))
