...
# source: pogoprotos/networking/responses/social/register_push_notification_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/social/register_push_notification_response.proto',
  package='pogoprotos.networking.responses.social',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nPpogoprotos/networking/responses/social/register_push_notification_response.proto\x12&pogoprotos.networking.responses.social\"\xb4\x01\n RegisterPushNotificationResponse\x12_\n\x06result\x18\x01 \x01(\x0e\x32O.pogoprotos.networking.responses.social.RegisterPushNotificationResponse.Result\"/\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\r\n\tNO_CHANGE\x10\x02\x62\x06proto3')
)
...
_REGISTERPUSHNOTIFICATIONRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.social.RegisterPushNotificationResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_REGISTERPUSHNOTIFICATIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.social.RegisterPushNotificationResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.social.RegisterPushNotificationResponse.result', index=0,
...
RegisterPushNotificationResponse = _reflection.GeneratedProtocolMessageType('RegisterPushNotificationResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.social.register_push_notification_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.RegisterPushNotificationResponse)
  ))
