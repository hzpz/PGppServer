...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\nNpogoprotos/networking/responses/social/get_facebook_friend_list_response.proto\x12&pogoprotos.networking.responses.social\x1a+pogoprotos/data/player/player_summary.proto\"\xdc\x03\n\x1dGetFacebookFriendListResponse\x12\\\n\x06result\x18\x01 \x01(\x0e\x32L.pogoprotos.networking.responses.social.GetFacebookFriendListResponse.Result\x12\x64\n\x06\x66riend\x18\x02 \x03(\x0b\x32T.pogoprotos.networking.responses.social.GetFacebookFriendListResponse.FacebookFriend\x12\x13\n\x0bnext_cursor\x18\x03 \x01(\t\x1aZ\n\x0e\x46\x61\x63\x65\x62ookFriend\x12\x35\n\x06player\x18\x01 \x01(\x0b\x32%.pogoprotos.data.player.PlayerSummary\x12\x11\n\tfull_name\x18\x02 \x01(\t\"\x85\x01\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x11\n\rERROR_UNKNOWN\x10\x02\x12\x16\n\x12\x45RROR_FACEBOOK_API\x10\x03\x12\x1e\n\x1a\x45RROR_FACEBOOK_PERMISSIONS\x10\x04\x12\x18\n\x14\x45RROR_NO_FACEBOOK_ID\x10\x05\x62\x06proto3')
  ,
...
_GETFACEBOOKFRIENDLISTRESPONSE_FACEBOOKFRIEND = _descriptor.Descriptor(
  name='FacebookFriend',
  full_name='pogoprotos.networking.responses.social.GetFacebookFriendListResponse.FacebookFriend',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='player', full_name='pogoprotos.networking.responses.social.GetFacebookFriendListResponse.FacebookFriend.player', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='full_name', full_name='pogoprotos.networking.responses.social.GetFacebookFriendListResponse.FacebookFriend.full_name', index=1,
...
GetFacebookFriendListResponse = _reflection.GeneratedProtocolMessageType('GetFacebookFriendListResponse', (_message.Message,), dict(
  ...
  FacebookFriend = _reflection.GeneratedProtocolMessageType('FacebookFriend', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.social.GetFacebookFriendListResponse.FacebookFriend)
    ))
  ,
