...
_FORTSEARCHRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='challenge_quest', full_name='pogoprotos.networking.responses.FortSearchResponse.challenge_quest', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gift_box', full_name='pogoprotos.networking.responses.FortSearchResponse.gift_box', index=14,
...
_FORTSEARCHRESPONSE.fields_by_name['challenge_quest'].message_type = pogoprotos_dot_data_dot_quests_dot_client__quest__pb2._CLIENTQUEST
_FORTSEARCHRESPONSE.fields_by_name['gift_box'].message_type = pogoprotos_dot_data_dot_gift_dot_gift__box__pb2._GIFTBOX
