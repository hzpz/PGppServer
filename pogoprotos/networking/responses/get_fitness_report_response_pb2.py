...
_GETFITNESSREPORTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.networking.responses.GetFitnessReportResponse.status', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='daily_reports', full_name='pogoprotos.networking.responses.GetFitnessReportResponse.daily_reports', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weekly_reports', full_name='pogoprotos.networking.responses.GetFitnessReportResponse.weekly_reports', index=2,
