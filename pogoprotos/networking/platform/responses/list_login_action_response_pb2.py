...
# source: pogoprotos/networking/platform/responses/list_login_action_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/platform/responses/list_login_action_response.proto',
  package='pogoprotos.networking.platform.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\nIpogoprotos/networking/platform/responses/list_login_action_response.proto\x12(pogoprotos.networking.platform.responses\x1a(pogoprotos/data/login/login_detail.proto\"d\n\x17ListLoginActionResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\x12\x38\n\x0clogin_detail\x18\x02 \x03(\x0b\x32\".pogoprotos.data.login.LoginDetailb\x06proto3')
  ,
...
_LISTLOGINACTIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.platform.responses.ListLoginActionResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='pogoprotos.networking.platform.responses.ListLoginActionResponse.success', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='login_detail', full_name='pogoprotos.networking.platform.responses.ListLoginActionResponse.login_detail', index=1,
...
ListLoginActionResponse = _reflection.GeneratedProtocolMessageType('ListLoginActionResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.platform.responses.list_login_action_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.platform.responses.ListLoginActionResponse)
  ))
