...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n:pogoprotos/settings/combat_challenge_global_settings.proto\x12\x13pogoprotos.settings\x1a\x31pogoprotos/enums/friendship_level_milestone.proto\"\xb0\x01\n\x1d\x43ombatChallengeGlobalSettings\x12\\\n(distance_check_override_friendship_level\x18\x01 \x01(\x0e\x32*.pogoprotos.enums.FriendshipLevelMilestone\x12\x31\n)get_combat_challenge_polling_interval_sec\x18\x02 \x01(\x05\x62\x06proto3')
  ,
...
CombatChallengeGlobalSettings = _reflection.GeneratedProtocolMessageType('CombatChallengeGlobalSettings', (_message.Message,), dict(
