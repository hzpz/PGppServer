...
_POKEMONSETTINGS = _descriptor.Descriptor(
  ...
  nested_types=[_POKEMONSETTINGS_POKEMONTHIRDMOVEATTRIBUTES, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
