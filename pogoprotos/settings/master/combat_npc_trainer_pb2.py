...
from pogoprotos.data import npc_pokemon_pb2 as pogoprotos_dot_data_dot_npc__pokemon__pb2
...
_COMBATNPCTRAINER.fields_by_name['available_pokemon'].message_type = pogoprotos_dot_data_dot_npc__pokemon__pb2._NPCPOKEMON
